      ...
      <div className="mt-3 w-full max-w-sm mx-auto">
        <div className="bg-white py-4 px-3 shadow rounded-lg">
          ...
          <div className="mt-3 space-y-2">
            <button
              type="button"
              className="w-full flex items-center justify-center px-3 py-2 border border-gray-300 rounded-md shadow-sm text-xs font-medium text-gray-700 bg-white hover:bg-gray-50 transition-colors duration-200"
            >
