...
export default function BookingManagement() {
  ...
  // Team members
  const teamMembers = [
    { id: 1, name: 'Sarah Joshi', role: 'Lead Photographer', avatar: '👩‍💼', availability: 'Available', bookings: 12 },
    { id: 2, name: 'David Kumar', role: 'Wedding Specialist', avatar: '👨‍💼', availability: 'Busy', bookings: 8 },
    { id: 3, name: 'Lisa Kumari', role: 'Portrait Expert', avatar: '👩‍🎨', availability: 'Available', bookings: 15 },
    { id: 4, name: 'Mark Wilson', role: 'Event Photographer', avatar: '👨‍🎨', availability: 'Available', bookings: 10 },
  ];
  ...
  const bookedDates: Record<string, { slots: number; type: string }> = {
    '2025-11-12': { slots: 4, type: 'Portrait' },
    '2025-11-17': { slots: 2, type: 'Product' },
          ...
          <div className="bg-white rounded-2xl shadow-lg p-4 md:p-6 border border-gray-100 opacity-0 animate-fadeInUp" style={{ animationDelay: '0.3s' }}>
            <div className="flex items-center justify-between mb-4">
              ...
              <div className="flex gap-2">
                ...
                <button 
                  onClick={goToToday}
                  className="px-3 py-2 hover:bg-blue-50 text-blue-600 rounded-lg text-sm font-semibold transition-colors"
                  title="Go to Today"
                >
                  Today
                </button>
            ...
            <div className="p-4 md:p-6">
              <div className="space-y-4">
                {upcomingBookings.map((booking, index) => (
                  <div
                    key={booking.id}
                    className="p-4 bg-gradient-to-r from-blue-50 to-indigo-50 rounded-xl hover:shadow-lg transition-all duration-200 border border-blue-200 opacity-0 animate-fadeInLeft"
          ...
          <div className="bg-white rounded-2xl shadow-2xl max-w-2xl w-full max-h-[90vh] overflow-y-auto">
            ...
            <form onSubmit={handleTeamFormSubmit} className="p-6 space-y-6">
              ...
              <div className="flex gap-4 pt-4 border-t border-gray-200">
                ...
                <button
                  type="submit"
                  className="flex-1 px-6 py-3 bg-gradient-to-r from-purple-600 to-pink-600 text-white rounded-lg font-semibold hover:shadow-lg transition-all duration-200"
                >
                  Add Team Member
                </button>
              </div>
