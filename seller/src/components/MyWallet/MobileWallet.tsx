    ...
    >
      ...
      <div className="max-w-7xl mx-auto">
        <div className="mb-6 md:mb-8 opacity-0 animate-fadeInDown">
          <h1 className="text-2xl md:text-3xl font-bold text-gray-900 mb-2">Wallet & Payments</h1>
          <p className="text-sm md:text-base text-gray-600">Manage and track all payment transactions</p>
        </div>
              ...
              >
                ...
                <div className="relative p-4 md:p-6">
                  <div className="flex items-center justify-between">
                    ...
                    <div className={`p-3 md:p-4 rounded-2xl bg-gradient-to-br ${stat.gradient} shadow-lg group-hover:scale-110 transition-transform duration-300`}>
