...
export default function DesktopFixedPackageManagement({ 
  ...
  const handleAddSubPackage = (groupId: string) => {
    ...
    const newSubPackage: SubPackage = {
      ...
      categoryId: subPackageFormData.selectedCategories[0], // Keep first category as primary
      ...
      <div className="admin-card">
        ...
        <div className="flex items-center justify-between mb-6">
          <div>
            ...
            <p className="text-sm text-gray-500 mt-1">Create package groups and add sub-packages with categories</p>
          </div>
          <button
            onClick={() => {
              setEditingGroup(null);
        ...
        {packageGroups.length === 0 && (
          <div className="text-center py-12 text-gray-500">
            No package groups found. Click "Add Package Group" to create one.
          </div>
        )}
      </div>
