        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-8">
          ...
          <div className="lg:col-span-1">
            ...
            <p className="text-gray-300 text-sm mb-4 max-w-xs">
              Connect with professional photographers and capture your special moments with ease.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-gray-300">
              ...
              <li><a href="#" className="hover:text-white transition-colors duration-200">Engagement Shoot</a></li>
              <li><a href="#" className="hover:text-white transition-colors duration-200">Family Portraits</a></li>
              <li><a href="#" className="hover:text-white transition-colors duration-200">Corporate Events</a></li>
              <li><a href="#" className="hover:text-white transition-colors duration-200">Graduation Photos</a></li>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-gray-300">
              ...
              <li><a href="#" className="hover:text-white transition-colors duration-200">Photographer Guide</a></li>
              <li><a href="#" className="hover:text-white transition-colors duration-200">Customer Reviews</a></li>
        ...
        <div className="border-t border-gray-700 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-sm text-gray-400 mb-4 md:mb-0">
              &copy; 2024 KliqShot. All rights reserved.
            </p>
