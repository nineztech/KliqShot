...
export default function VideoSection() {
  ...
  return (
    <div className="relative w-full h-72 md:h-80 lg:h-96 xl:h-[28rem] bg-gray-900 overflow-hidden">
        ...
        <div className="absolute inset-0 flex items-center justify-center">
          <div className="text-center text-white">
            ...
            <button
              ...
              className="inline-flex items-center justify-center w-16 h-16 md:w-20 md:h-20 bg-white bg-opacity-20 hover:bg-opacity-30 rounded-full transition-all duration-200 backdrop-blur-sm"
            >
              {isPlaying ? (
