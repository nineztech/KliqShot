        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          {steps.map((step, index) => (
            <div key={index} className="relative group">
              {/* Step Card */}
              <div className={`relative bg-gradient-to-br ${step.bgGradient} rounded-2xl p-6 shadow-lg border ${step.borderColor} hover:shadow-xl transition-all duration-300 hover:scale-105`}>
                {/* Step Number Badge */}
                ...
                {/* Icon Container */}
                <div className={`flex items-center justify-center w-16 h-16 bg-gradient-to-br ${step.gradient} rounded-2xl mx-auto mb-4 group-hover:scale-110 transition-transform duration-300 shadow-lg`}>
                  {step.icon}
                </div>
